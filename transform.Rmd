...
*Adding a '-' before the variable also sorts the values in descending order.*
...
1.  What happens if you include the name of a variable multiple times in
    ...
    *It only returns it ones. A tibble object can't have two variables with the same name so it just returns a tibble of one row.*
...
```{r}
flights_sml <- select(flights,  #ejecutando este chunk se tienes flights_ en el directorio
  year:day, 
  ends_with("delay"), 
  distance, 
  air_time
